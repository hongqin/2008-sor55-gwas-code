### Aug 31, 09 update annotation based on cal21-annotation.csv
...
labels = c( "orf", "chr", "gene", "geneflag", "WtMean","MutMean","WtMean2","MutMean2",  "fold.mut.by.wt", "p", "p.paired", "w1", "w2", "w3", "m1", "m2", "m3");
...
for( myorf in as.character( orfs ) ) {
 ...
 wt2 = c(v1b,v2b,v3b);
 out[i,c("w1", "w2", "w3")] = wt2;  #090109 change
 ...
 mut2 = c(u1b,u2b,u3b);
 out[i,c("m1", "m2", "m3")] = mut2; #090109 change
...
ch5.tb = out[out$chr=='Chr5', ]
write.table(ch5.tb, "_chr5.tableS2.out.sor55.nonCh5norm.090109.csv", col.names=T, row.names=F, quote=F, sep="\t");
