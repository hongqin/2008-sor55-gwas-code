...
for ( i in 1:length(chrs)) {
	...
	pdf( paste("_012308", mychr,"pdf",sep="."),height=3,width=5);
	plot( exp.chr5$fold.mut.by.wt ~ exp.chr5$loc, col="white",xlab='bp',ylab='sor55/wt',log='y', main= paste( "expression ratio sor55/wt along", mychr, sep=' ') );
