...
### 110208 adjust color, refine plot for publication
...
expecteds = c(0.05, 0.9, 0.05) * window;
 ...
 pdf( "_110208-chr5-chisq.pdf",height=3,width=4);
...
#	if ( i == length(chrs) ) {
#	  par(mar=c(2,2,0,1));
	  plot( exp.chrtb$fold.mut.by.wt ~ exp.chrtb$loc, col="white",ylab='sor55/wt',log='y',
		xlim=xlim,ylim=ylim, xlab='Chromosome length (Mb)', axes=F ); 
