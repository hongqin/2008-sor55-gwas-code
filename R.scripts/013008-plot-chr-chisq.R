# the clusters does look right along chr5, 013008. I need some serious double check. 
### Jan 30, 2008
### plot expression ratio along chromosomes overlayed with sliding 
### window chi-square test
...
#window.bp = 0.5E5;  window = 17;  pcutoff = 1E-6;
