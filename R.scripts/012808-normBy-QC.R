### Jan 28, 2008
### normalization by QC probes, check expression by chromosomes
### 
...
write.table(out, "_out.Sor55.byChr.012808.normalized.byQC.csv", col.names=T, row.names=F, quote=F, sep="\t");

###

save.image("012808-QC-normalizaiton.RData");
