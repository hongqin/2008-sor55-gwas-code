### Jan 3, 2008
### use orfs as normalization to find non-expressed genes
...
write.table(out, "_out.Sor55.010308.csv", col.names=T, row.names=F, quote=F, sep="\t");
...
write.table(bottom, "_out.Sor55.bottom5percent.010308.csv", col.names=T, row.names=F, quote=F, sep="\t");
