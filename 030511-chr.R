...
out$loc   = out$start /2  + out$end/2 
 ...
 save.image ("030511.bkgrdCorrected.nonChr457Normalized.myChr.RData");


#xscale = 3.2; #March 5, 2011 change , Does not work. 
#out$start = out$start / 1E6
#out$end   = out$end / 1E6
...
expecteds = c(0.05, 0.9, 0.05) * window;
 ...
 pdf( "_030511-chrs-chisq.pdf",height=9,width=6);
