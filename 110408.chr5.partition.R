...
#left  = c(-999,  0.4, 0.6, 0.9, 1.1, 1.6, 2.1); #110208
#right = c(0.4,   0.6, 0.9, 1.1, 1.6, 2.1, 9999); #110208
left  = c(-999,  0.4, 0.6, 0.9, 1.1, 1.9, 2.1);  #110408
right = c(0.4,   0.6, 0.9, 1.1, 1.9, 2.1, 9999); #110408

#left  = c(-999,  0.4, 0.6, 0.75, 1.25, 1.9, 2.1);  #022709
#right = c(0.4,   0.6, 0.75, 1.25, 1.9,  2.1, 9999); #022709
...
#out$percen  = out$freq  / sum(out$freq);
out$percenB = out$freqB / sum(out$freqB);
