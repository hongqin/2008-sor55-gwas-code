### March 3, 2011, double-check std for ratios. Some probes give nealy background signals, which leads to extremely high std for ratios. 
### 
...
write.csv( out, "_out.sor55.nonCh5norm.with.sd.030311.csv", row.names=F);
save( out, file="_030311.out.with.sd.RData");
